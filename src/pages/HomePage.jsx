            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-8 md:text-xl">
                        ...
                        eum vero assumenda voluptate, minima nemo doloremque natus accusamus
                    </p>
                </div>
                <Link to={'/write'} className="hidden md:block relative">
                    ...
                    >
                        ...
                        />
                        <text>
                            <textPath href="#circlePath" startOffset={"0%"}>Write your text</textPath>
                            <textPath href="#circlePath" startOffset={"50%"}>Write your text</textPath>
                        </text>
                    </svg>
